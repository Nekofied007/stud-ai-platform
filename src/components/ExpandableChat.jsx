...
export const ChatPosition = "bottom-right" | "bottom-left";
export const ChatSize = "sm" | "md" | "lg" | "xl" | "full";
...
const ExpandableChatBody = ({
  className,
  ...props
}) => <div className={cn("flex-grow overflow-y-auto p-4", className)} {...props} />;
